...
public class NotificationUtils {
    private static final int ID_PENDING_INTENT = 2017;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setStyle(new NotificationCompat.BigTextStyle().bigText(context.getString(R.string.instructions)))
        ...
        notificationManager.notify(ID_PENDING_INTENT, builder.build());
    ...
    public static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, ID_PENDING_INTENT, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static Bitmap largeIcon(Context context) {
        ...
        return new BitmapFactory().decodeResource(resources, R.drawable.ic_local_drink_black_24px);
    }
