...
//        TestUtil.insertFakeData(mDb);
    ...
    public void addToWaitlist(View view) {
        ...
        if (TextUtils.isEmpty(mNewGuestNameEditText.getText()) || TextUtils.isEmpty(mNewPartySizeEditText.getText())) return;
        ...
        try {
            partySize = Integer.valueOf(mNewPartySizeEditText.getText().toString());
