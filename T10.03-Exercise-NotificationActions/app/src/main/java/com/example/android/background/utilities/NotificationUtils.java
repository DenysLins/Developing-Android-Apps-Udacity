...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 3418;
    private static final int ACTION_CANCEL_NOTIFICATION_PENDIND_INTENT_ID = 3419;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,
                ACTION_CANCEL_NOTIFICATION_PENDIND_INTENT_ID,
                intent,
