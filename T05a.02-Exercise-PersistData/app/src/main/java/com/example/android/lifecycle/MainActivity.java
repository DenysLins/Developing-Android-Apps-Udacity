...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = Intent.EXTRA_TEXT;
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        CharSequence text = mLifecycleDisplay.getText();
        outState.putCharSequence(LIFECYCLE_CALLBACKS_TEXT_KEY, text);
    }
