...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_SEARCH_ID = 100;
...
//        loadWeatherData();
        getSupportLoaderManager().initLoader(WEATHER_SEARCH_ID, null, this);
    }
...
//        new FetchWeatherTask().execute(location);
        getSupportLoaderManager().restartLoader(WEATHER_SEARCH_ID, null, this);
