...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast errorMessage = Toast.makeText(getActivity(), getString(R.string.pref_size_error_message), Toast.LENGTH_SHORT);
        try {
            Float floatValue = Float.valueOf(String.valueOf(newValue));
