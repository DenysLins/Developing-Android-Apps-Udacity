...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTaskDescription = (EditText) findViewById(R.id.editTextTaskDescription);
    }
    ...
    public void onClickAddTask(View view) {
        ...
        if (!(TextUtils.isEmpty(etTaskDescription.getText()))) {

            ContentValues contentValues = new ContentValues();
            contentValues.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, etTaskDescription.getText().toString());
