...
//      Completed (13) Find each of the TextViews by ID
        tvDate = (TextView) findViewById(R.id.tv_day_date);
        tvDescription = (TextView) findViewById(R.id.tv_day_description);
        tvHigh = (TextView) findViewById(R.id.tv_day_high_temp);
        tvLow = (TextView) findViewById(R.id.tv_day_low_temp);
        tvHumidity = (TextView) findViewById(R.id.tv_day_humidity);
        tvWind = (TextView) findViewById(R.id.tv_day_wind);
        tvPressure = (TextView) findViewById(R.id.tv_day_pressure);
...
//      TODO (35) Initialize the loader for DetailActivity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data != null) {
            ...
            int id = data.getInt(DetailActivity.INDEX_WEATHER_ID);
            String description = SunshineWeatherUtils.getStringForWeatherCondition(getApplicationContext(), id);
            tvDescription.setText(description);
            //      Completed (28) Display the high temperature
            double high = data.getDouble(DetailActivity.INDEX_WEATHER_MAX_TEMP);
            String stringHigh = SunshineWeatherUtils.formatTemperature(getApplicationContext(), high);
            tvHigh.setText(stringHigh);
